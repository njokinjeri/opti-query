    ...
    return (
        <section id="cta" className="w-full max-w-7xl mx-auto flex border border-white/20 rounded-xl overflow-hidden relative">
            <div className="absolute inset-0 pointer-events-none">
                ...
                <img src={shadow} alt="" className="absolute top-40 md:top-0 left-1/3 -translate-x-1/2 w-[120%] max-w-none z-5" />
                <img src={blur} alt="" className="absolute bottom-40 md:bottom-0 inset-x-0 w-full z-2" />
            </div>
